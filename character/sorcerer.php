...
<head>
    ...
    <link rel="stylesheet" href="../css/sorcerer.css?v=<?php echo time(); ?>">
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-5 text-white">
                    <h1 class="c-name">SORCERER</h1>
                    <p class="c-desc">Seorang penyihir yang visioner (#Visioner), berfokus pada masa depan (#ToTheFuture), dan memiliki otak yang brilian (#BigBrain). Dia cenderung kurang dalam tindakan langsung, tetapi mampu merencanakan strategi dengan baik dan sangat kreatif dalam menggunakan sihirnya. Meskipun kurang dalam simpati dan interaksi social, dia memiliki idealisme yang kuat  dan fleksibel untuk menyesuaikan rencana dengan perubahan.</p>
                </div>
                <div class="col-4 text-white d-flex flex-column align-items-center justify-content-center">
                    <h1 class="c-name">DESKRIPSI</h1>
                    <p class="c-desc">Seseorang yang memiliki visi yang kuat dan selalu berpikir di luar kotak, seperti seorang inovator atau pengusaha yang selalu mencari cara baru untuk memecahkan masalah.</p>
                </div>
            </div>
            <div class="row d-flex justify-content-between mt-5">
                <div class="col-5 text-white" style="padding-left: 2rem;">
                    ...
                    <p class="c-desc">
                        <ul class="fs-3 fw-bold">
                            <li>Mampu merencanakan strategi dengan baik</li>
                            <li>Sangat kreatif memiliki ide dalam perencanaan sebuah </li>
                            <li>Tindakan</li>
                ...
                <div class="col-4 text-white d-flex flex-column align-items-start">
                    ...
                    <p class="c-desc">Ilmuwan peneliti atau ahli strategi bisnis, di mana kemampuan untuk merencanakan dan melihat ke depan sangat dihargai.</p>
                </div>
            </div>
            <div class="row d-flex justify-content-between mt-5">
                <div class="col-5 text-white" style="padding-left: 2rem;">
                ...
                <div class="col-4 text-white d-flex flex-column align-items-start">
                    ...
                    <p class="c-desc">Knight, Archer, Alchemist :
                        Rancangan/strategi yang sudah disusun dengan baik dan kreatif memerlukan seseorang yang dapat mengeksekusinya</p>
                </div>
            </div>
        </div>
    </section>
