...
<head>
    ...
    <link rel="stylesheet" href="../css/healer.css?v=<?php echo time(); ?>">
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-5 text-white">
                    <h1 class="c-name">HEALER</h1>
                    <p class="c-desc">Seorang penyembuh yang penuh kasih sayang (#Penyayang, #Love) dan romantis (#Romantis). Dia lebih cenderung merencanakan tindakannya  dan kreatif dalam memberikan solusi untuk mempertahankan teman-temannya, tetapi kurang dalam hal tindakan langsung  dan kurang fleksibel dalam mengubah rencana. Dia memiliki idealisme yang kuat, serta simpati dan keterampilan sosial yang baik.</p>
                </div>
                <div class="col-4 text-white d-flex flex-column align-items-center justify-content-center">
                    <h1 class="c-name">DESKRIPSI</h1>
                    <p class="c-desc">Seseorang yang memiliki hati yang besar dan selalu siap membantu orang lain, seperti seorang relawan di organisasi amal atau seorang profesional di bidang kesehatan.</p>
                </div>
            </div>
                ...
                <div class="col-5 text-white" style="padding-left: 2rem;">
                    ...
                    <p class="c-desc">
                        <ul class="fs-3 fw-bold">
                            <li>Merencanakan tindakan dengan baik</li>
                            <li>Idealisme yang kuat</li>
                            <li>Memiliki simpati dan kemampuan interaksi social yang tinggi</li>
                        </ul>
                    </p>
                </div>
                <div class="col-4 text-white d-flex flex-column align-items-start">
                    <h1 class="c-suggest">Carrer Suggestion</h1>
                    <p class="c-desc">Profesi dalam bidang kesehatan, seperti dokter, perawat, atau terapis, di mana kemampuan untuk memberikan perawatan dan dukungan yang efektif sangat dihargai. Atau, dalam bidang psikologi atau konseling, di mana keterampilan mendengarkan dan memberikan bantuan emosional sangat penting.</p>
                </div>
            </div>
            <div class="row d-flex justify-content-between mt-5">
                <div class="col-5 text-white" style="padding-left: 2rem;">
                ...
                <div class="col-4 text-white d-flex flex-column align-items-start">
                    ...
                    <p class="c-desc">Knight:
                        Dibutuhkannya teammate yang baik dalam tindakan langsung</p>
                </div>
            </div>
        </div>
    </section>
