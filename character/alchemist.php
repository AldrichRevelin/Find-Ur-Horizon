...
<head>
    ...
    <link rel="stylesheet" href="../css/alchemist.css?v=<?php echo time(); ?>">
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-5 text-white">
                    <h1 class="c-name">ALCHEMIST</h1>
                    <p class="c-desc">Seorang ahli kimia yang kreatif (#Kreatif, #1001Ide) dan jenius (#Jenius). Dia cenderung bertindak dan merencanakan dengan baik , tetapi mungkin kurang dalam hal simpati dan interaksi sosial . Meskipun demikian, dia memiliki idealisme yang kuat  dan fleksibilitas dalam beradaptasi dengan perubahan.</p>
                </div>
                <div class="col-4 text-white d-flex flex-column align-items-center justify-content-center">
                    <h1 class="c-name">DESKRIPSI</h1>
                    <p class="c-desc">Seseorang yang memiliki kecenderungan untuk mencari tahu dan eksperimen dengan ide-ide baru, seperti seorang peneliti atau penemu yang berdedikasi.</p>
                </div>
            </div>
            <div class="row d-flex justify-content-between mt-5">
                <div class="col-5 text-white" style="padding-left: 2rem;">
                    ...
                    <p class="c-desc">
                        <ul class="fs-3 fw-bold">
                            <li>Kreatif dan jenius dalam merancang tindakan</li>
                ...
                <div class="col-4 text-white d-flex flex-column align-items-start">
                    ...
                    <p class="c-desc">Ilmuwan peneliti atau pengembang produk, di mana kemampuan untuk menciptakan solusi baru dan beradaptasi dengan perubahan pasar sangat dihargai. Atau, dalam bidang teknologi atau inovasi, di mana kreativitas dan kejeniusan dalam menciptakan solusi baru sangat dihargai.</p>
                </div>
            </div>
            <div class="row d-flex justify-content-between mt-5">
                <div class="col-5 text-white" style="padding-left: 2rem;">
                ...
                <div class="col-4 text-white d-flex flex-column align-items-start">
                    ...
                    <p class="c-desc">Sorcerer :
                        Sesama memiliki kekreatifan yang tinggi membantu memberikan solusi inovatif  dari strategi yang sudah dibuat.</p>
                </div>
            </div>
        </div>
    </section>
